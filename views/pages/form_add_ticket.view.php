...
>>>>>>> cc9653a95077ffb5a33c512805a841ad740aed40
                        </div>
                        <div>
                    ...
                    <div class="ml-64 mb-5 space-x-1">
                        <span class="bg-red-500 p-1.5 rounded-lg" onclick="cancel()">
                            Cancel
                        </span>
                        <span class="bg-blue-500 p-1.5 rounded-lg w-14" onclick="addTickets()">
                            Add
                        </span>
                    </div>
                </form>
