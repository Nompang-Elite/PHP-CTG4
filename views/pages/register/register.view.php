    ...
    <div class="flex h-full w-full">
        ...
        <form action="/register" method="POST" id="regis-form" class="flex flex-col gap-[0.5rem] shadow-md justify-center items-center w-[36rem] min-w-[20rem] max-sm:w-full">
            ...
            <label class="w-full flex flex-col">
                ...
                <input type="text" name="username" id="username" placeholder="User Name" class="p-2 rounded-md max-w-8/10 w-10/12 ml-9 bg-transparent outline-none bg-gray-800 ">
            </label>
            <label class="flex w-full flex-row">
                <label class="flex w-full flex-col">
                    <label class="ml-9">Date Of Birth</label>
                    <input type="date" name="birthDate" id="date" placeholder="date" class="p-2 rounded-md max-w-8/10 ml-9 w-9/12 bg-transparent outline-none bg-gray-800">
                </label>
                <label class="flex w-full flex-col">
            ...
            <label class="flex w-full flex-row">
                <label class="flex w-full flex-col">
                    ...
                    <input type="password" name="password" id="password" onkeyup="validatePassword()" placeholder="Password" class="p-2 rounded-md max-w-8/10 ml-9 w-9/12 bg-transparent outline-none bg-gray-800">
