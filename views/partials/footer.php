...
<footer class="relative z-10 bg-slate-900 text-white pt-10 pb-10 lg:pt-[100px] lg:pb-8">
    <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="mb-10 w-full">
            <div class="mb w-full ml-14">
                <a href="javascript:void(0)" class="mb-6 inline-block ml-12  max-w-[160px]">
                <!-- <img
                ...
                <div >
                    <img 
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrB-p7Cclj2jnO6NdQpk3OgD03dPCNit9EPw&usqp=CAU" 
                    alt="" width="50%" class="rounded-full">
                </div>
                </a>
            </div>
            
            <p class="text-body-color mb-7 ml-10 text-base grid">
              Address: Building 422 St. 271, Phum 1,
              Stung Mean Chey Khan MeanChey, Phnom Penh
              Email: villa.nhea@student.passerellesnumeriques
              +855 (0) 69 720 727
            </p>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div class="mb-10 w-full ml-12">
            <h4 class="text-dark mb-5 text-lg font-semibold">Resources</h4>
            <ul>
              <li>
                <a
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div class="mb-10 w-full ml-9">
            <h4 class="text-dark mb-5 text-lg font-semibold">Company</h4>
            <ul>
              <li>
                <a
                  href="javascript:void(0)"
        ...
        <div class="w-full px-4 sm:w-1/1 lg:w-2/12">
        ...
        <div class="w-full px-12 sm:w-1/4 lg:w-2/20">
          <div class="mb-10 w-full ml-9">
            ...
            <p class="text-body-color text-base">&copy; 2023 Ticket</p>
          </div>
        </div>
      </div>
    </div>
