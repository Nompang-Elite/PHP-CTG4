<div class=" bg-opacity-5 text-white shadow-lg hidden md:block">

    <nav class="border-gray-200 px-2  mb-10 bg-white">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
      <a href="#" class="flex ">
        <img class="m-1" src="/images/logo.png" alt="" width="50" height="50" >
        <span class="self-center text-lg font-semibold whitespace-nowrap text-gray-700">Blue Sky</span>
      </a>
      ...
      <div class="hidden md:flex justify-between items-center w-full md:w-auto md:order-1 " id="mobile-menu-3">
        <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
          <li>
            <a href="#" class="md:bg-transparent text-gray-700 block pl-3 pr-4 py-2  md:p-0 rounded md:hover:text-blue-700" aria-current="page">Home</a>
          </li>
          <li>
      ...
      <div class="flex md:order-3">
        ...
        <button class="bg-blue-500 p-1.5 ml-3 rounded-lg">Registers</button>
      </div>
      </div>
    </nav>
  </div>