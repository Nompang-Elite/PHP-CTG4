...
<section class="flex h-screen">
            <div class="flex w-full items-center justify-center bg-slate-700 lg:py-0">
                <div
                    class="flex felx-row rounded-lg justify-center h-full w-full">
                        ...
                        <form class="space-y-4 md:space-y-6 w-full" action="#">
                            <div class="ml-10">
                                ...
                                <input type="email" name="email" id="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-11/12 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <button type="submit"
                                class="w-10/12 ml-10 rounded-lg text-sm p-2 text-center bg-blue-500">Sign
                                in</button>
                            <hr>
                            <p class="text-sm ml-4 font-light text-center">
                                Need an account? <a href="#"
                                    class="font-medium text-primary-600 hover:underline dark:text-primary-500">Create a new account</a>
                            </p>
                        </form>
                    </div>
                </div>
